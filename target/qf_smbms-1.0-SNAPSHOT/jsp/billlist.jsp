...
<div class="right">
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
		...
		<input type="hidden" id="totalPageCount" value="${billList.pages}"/>
		<c:import url="rollpage.jsp">
			<c:param name="totalCount" value="${billList.total}"/>
			<c:param name="currentPageNo" value="${billList.pageNum}"/>
			<c:param name="totalPageCount" value="${billList.pages}"/>
		</c:import>
  </div>
</section>
